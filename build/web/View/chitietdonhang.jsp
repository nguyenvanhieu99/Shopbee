<%-- 
    ...
    Created on : Dec 13, 2020, 6:57:09 PM
    Author     : Hiep Le
--%>
...
<nav>
	...
	<br><br>
		...
		<%
                    ...
                    if(session.getAttribute("chitiet")!=null)
                    dsdh = (ArrayList<Chitietdonhang>) session.getAttribute("chitiet");
                %>		
                    <table id="customers">				
                        <tr>                           
                           <th>SẢN PHẨM</th>
                        ...
                        <% 
                            for(Chitietdonhang i : dsdh)
                            {
                                tongtien+=i.getSp().getGia();
                        %>
                        <tr>                                                   
                            <td><%=i.getSp().getTenSP() %></td>
                            <td><%=i.getSp().getGia() %></td>
                            <td><%=i.getSoluong()%> </td>                                                       
                        </tr>
                        <%} %>				
                    </table>
