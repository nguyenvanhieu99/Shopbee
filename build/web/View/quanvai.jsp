<%-- 
    Document   : quanvai
    Created on : Dec 6, 2020, 5:22:57 PM
    Author     : Hiep Le
--%>
...
<html>
<head>
	<title>Quần vải - Thoi trang</title>
...
<div class="slide">
      <script type="text/javascript">
            if(document.images){
               ...
               image1.src = "img/nenquanvai.jpg";
               var image2 = new Image(); 
               image2.src = "img/Sale.png";
            }
      </script>
      <a href="#" onMouseOver="document.myImage.src=image2.src;" onMouseOut="document.myImage.src=image1.src;">
      <img name="myImage" src="img/nenquanvai.jpg" width="700px" height="357px" />
      </a>
</div>
<br />

<img src="img/quanvai.png" width="700px" height="35px" />
<br />
<br />
...
<!--<div class="box">
	<a class="a" href="#"><img src="img/quanvai1.jpg" width="220px" height="295px" /></a>
	<div align="center">
	<a href="#">quần vải 100% cotton</a>
	</div>
	<p><del>1.234.000 VNĐ</del></p>
	<h4>990.000 VNĐ</h4>
	<div align="center">
...
<div class="box">
	<a class="a" href="#"><img src="img/quanvai2.jpg" width="220px" height="295px" /></a>
	<div align="center">
	<a href="#">quần vải nữ UNIQLO</a>
	</div>
	<p><del>1.520.000 VNĐ</del></p>
	<h4>999.000 VNĐ</h4>
	<div align="center">
	<input class="button-buy button" type="button" onclick="myClick()" value="Mua hàng" />
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/quanvai3.jpg" width="220px" height="295px"/></a>
	<div align="center">
	<a href="#">quần vải nữ hình in</a>
	</div>
