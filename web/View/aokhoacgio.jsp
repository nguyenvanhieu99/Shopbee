<%-- 
    Document   : aokhoacgio
    Created on : Dec 7, 2020, 5:02:48 PM
    Author     : Hiep Le
--%>
...
<html>
<head>
	<title>Áo khoác gió - Thoi trang</title>
...
<div id="thanhtoan" class="modal" style="display : none"> 
    <form action="thanhtoan" method="post" class="modal-content" enctype="multipart/form-data">
...
<div class="slide">
      <script type="text/javascript">
            if(document.images){
               ...
               image1.src = "img/nenkhoacgio.jpg";
...
<img src="img/khoacgio.png" width="700px" height="35px" />
<br />
<br />
...
<!--<div class="box">
	<a class="a" href="#"><img src="img/aokhoac1.jpg" width="220px" height="295px" /></a>
	<div align="center">
	<a href="#">áo khoác nữ 100% cotton</a>
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/aokhoac2.jpg" width="220px" height="295px" /></a>
	<div align="center">
	<a href="#">áo khoác UNIQLO 2</a>
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/aokhoac3.jpg" width="220px" height="295px"/></a>
	<div align="center">
	<a href="#">áo khoác dài</a>
	</div>
	<p><del>1.200.000 VNĐ</del></p>
	<h4>850.000 VNĐ</h4>
	<div align="center">
