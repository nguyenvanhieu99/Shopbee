<%-- 
    Document   : quankhaki
    Created on : Dec 7, 2020, 4:40:52 PM
    Author     : Hiep Le
--%>
...
<html>
<head>
	<title>Quần Khaki - Thoi trang</title>
...
<div class="slide">
      <script type="text/javascript">
            if(document.images){
               ...
               image1.src = "img/nenkhaki.jpg";
               var image2 = new Image(); 
               image2.src = "img/Sale.png";
            }
      </script>
      <a href="#" onMouseOver="document.myImage.src=image2.src;" onMouseOut="document.myImage.src=image1.src;">
      <img name="myImage" src="img/nenkhaki.jpg" width="700px" height="357px" />
      </a>
</div>
<br />

<img src="img/khaki.png" width="700px" height="35px" />
<br />
<br />
...
<!--<ul>
	<li>sản phẩm hiện đang không còn hàng, quý khách vui lòng quay trở lại vào mùa hè năm sau để có thể mua cho mình những món đồ ưng ý nhất!</li>
	<div align="justify">
