<%-- 
    Document   : somi
    Created on : Dec 6, 2020, 5:21:50 PM
    Author     : Hiep Le
--%>
...
<div class="slide">
      <script type="text/javascript">
            if(document.images){
               ...
               image1.src = "img/biasomi.jpg";
               var image2 = new Image(); 
               image2.src = "img/Sale.png";
            }
      </script>
      <a href="#" onMouseOver="document.myImage.src=image2.src;" onMouseOut="document.myImage.src=image1.src;">
      <img name="myImage" src="img/biasomi.jpg" width="700px" height="357px" />
      </a>
</div>
<br />

<img src="img/somi.png" width="700px" height="35px" />
<br />
<br />
...
<!--<div class="box">
	<a class="a" href="#"><img src="img/somi1.jpg" width="220px" height="295px" /></a>
	<div align="center">
	<a href="#">sơ mi nữ trẻ trung</a>
	</div>
...
<div class="box">
	<a class="a" href="trinam2.html"><img src="img/somi2.jpg" width="220px" height="295px" /></a>
	<div align="center">
	<a href="trinam2.html">áo sơ mi nữ đi chơi</a>
	</div>
...
<div class="box">
	<a class="a" href="trinam3.html"><img src="img/somi3.jpg" width="220px" height="295px"/></a>
	<div align="center">
	<a href="trinam3.html">áo sơ mi đi làm</a>
	</div>
	<p><del>5.200.000 VNĐ</del></p>
	<h4>4.850.000 VNĐ</h4>
	<div align="center">
	<input class="button-buy button" type="button" onclick="myClick()" value="Mua hàng" />
	</div>
