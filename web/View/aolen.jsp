<%-- 
    Document   : aolen
    Created on : Dec 7, 2020, 5:01:43 PM
    Author     : Hiep Le
--%>
...
<div class="slide">
      <script type="text/javascript">
            if(document.images){
               ...
               image1.src = "img/lenchay1.png";
               var image2 = new Image(); 
               image2.src = "img/Sale.png";
            }
      </script>
      <a href="#" onMouseOver="document.myImage.src=image2.src;" onMouseOut="document.myImage.src=image1.src;">
      <img name="myImage" src="img/lenchay1.png" width="700px" height="357px" />
      </a>
</div>
<br />

<img src="img/aolen.png" width="700px" height="35px" />
<br />
<br />
...
<!--<div class="box">
	<a class="a" href="#"><img src="img/len1.jpg" width="220px" height="295px" /></a>
	<div align="center">
	<a href="#">áo len M1</a>
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/len2.jpg" width="220px" height="295px" /></a>
	<div align="center">
	<a href="#">áo len M2</a>
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/len3.jpg" width="220px" height="295px"/></a>
	<div align="center">
	<a href="#">áo len M3</a>
	</div>
	<p><del>3.200.000 VNĐ</del></p>
	<h4>2.850.000 VNĐ</h4>
	<div align="center">
	<input class="button button-buy" type="button" onclick="myClick()" value="Mua hàng" />
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/len4.jpg" width="220px" height="295px"/></a>
	<div align="center">
	<a href="#">áo len M5</a>
	</div>
	<p><del>1.200.000 VNĐ</del></p>
...
<div class="box">
	<a class="a" href="#"><img src="img/len5.jpg" width="220px" height="295px"/></a>
	<div align="center">
	<a href="#">áo len M4</a>
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/len6.jpg" width="220px" height="295px"/></a>
	<div align="center">
	<a href="#">áo len M6</a>
	</div>
	<p><del>2.630.000 VNĐ</del></p>
	<h4>1.990.000 VNĐ</h4>
	<div align="center">
	<input class="button button-buy" type="button" onclick="myClick()" value="Mua hàng" />
	</div>
