<%-- 
    Document   : maconha
    Created on : Dec 7, 2020, 4:46:15 PM
    Author     : Hiep Le
--%>
...
<html>
<head>
	<title>Mặc ở nhà - Thoi trang</title>
...
<div class="slide">
      <script type="text/javascript">
            if(document.images){
               ...
               image1.src = "img/nenonha.jpg";
               var image2 = new Image(); 
               image2.src = "img/Sale.png";
            }
      </script>
      <a href="#" onMouseOver="document.myImage.src=image2.src;" onMouseOut="document.myImage.src=image1.src;">
      <img name="myImage" src="img/nenonha.jpg" width="700px" height="357px" />
      </a>
</div>
<br />

<img src="img/onha.png" width="700px" height="35px" />
<br />
<br />
...
<!--<div class="box">
	<a class="a" href="#"><img src="img/onha1.jpg" width="220px" height="295px" /></a><br />
	<div align="center">
	<a href="#">áo mặc ở nhà</a>
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/onha2.jpg" width="220px" height="295px" /></a><br />
	<div align="center">
	<a href="#">áo ULIQLO</a>
	</div>
	<p><del>6.000.000 VNĐ</del></p>
	<h4>5.900.000 VNĐ</h4>
	<div align="center">
	<input class="button-buy button" type="button" onclick="myClick()" value="Mua hàng" />
	</div>
...
<div class="box">
	<a class="a" href="#"><img src="img/onha3.jpg" width="220px" height="295px"/></a><br />
	<div align="center">
	<a href="#">quần ULIQLO sexy</a>
	</div>
	<p><del>1.200.000 VNĐ</del></p>
	<h4>400.000 VNĐ</h4>
	<div align="center">
