<%-- 
    Document   : congso
    Created on : Dec 7, 2020, 4:54:40 PM
    Author     : Hiep Le
--%>
...
<html>
<head>
	<title>Công sở - Thoi trang</title>
...
<div class="slide">
      <script type="text/javascript">
            if(document.images){
               ...
               image1.src = "img/gioithieu2.jpg";
               var image2 = new Image(); 
               image2.src = "img/Sale.png";
            }
      </script>
      <a href="#" onMouseOver="document.myImage.src=image2.src;" onMouseOut="document.myImage.src=image1.src;">
      <img name="myImage" src="img/gioithieu2.jpg" width="700px" height="357px" />
      </a>
</div>
<br />

<img src="img/congso.png" width="700px" height="35px" />
<br />
<br />
...
<!--<div class="box">
	<a class="a" href="#"><img src="img/longcuu1.jpg" width="220px" height="295px" /></a>
	<div align="center">
