 ...
 * @author Hiep Le
 */
@WebServlet(name = "show_Siteadmin_quanlyKH", urlPatterns = {"/show_Siteadmin_quanlyKH"})
public class show_Siteadmin_quanlyKH extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet show_Siteadmin_quanlyKH</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet show_Siteadmin_quanlyKH at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
