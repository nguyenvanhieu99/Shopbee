 ...
 * @author Hiep Le
 */
@WebServlet(name = "setup_Cookie", urlPatterns = {"/setup_Cookie"})
public class setup_Cookie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(cookies!=null)
        {
            for(int i = 0;i< cookies.length;i++)
            {
               ...
               {
                   taikhoan = cookie.getValue();
               }
               if(cookie.getName().equals("mk"))
               {
